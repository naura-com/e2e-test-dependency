...
public class ManualJobSteps {
    ...
    public void loadAndsynWithCTC() {
        mainPage.manualPage().waferSynchPage().cleanChamber();
    ...
    public void 的lotID设置成功(String lp, String verification) {
        mainPage.manualPage().manualJobPage().setLPLotIDSuc(lp, verification);
    }
    ...
    public void loadlock存在running状态的job(DataTable table) {
        mainPage.manualPage().manualJobPage().createStatusJob(table);
    }
