...
//        return false;
    ...
    public void setLPLotIDSuc(String lp, String verification) {
        switch (lp) {
            case "LoadLock A":
    ...
    public void createStatusJob(DataTable table) {
        setSingleWaferJob(table);
        lpActionClick(table.row(1).get(0), "Start");
        waitJobRunning(table.row(1).get(0));
    }
}
