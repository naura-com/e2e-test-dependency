...
public class ManualMovePage extends ParentPage {
    ...
    private void clickByOffset(int x, int y, String eleName) {
        new Actions(winForm.getWindowsDriver()).moveToElement(page.elementByName(eleName).getElement(), x, y).click().click().perform();
    }

    public void selectModule(String module, String name) {
        switch (module) {
            case "PM2":
