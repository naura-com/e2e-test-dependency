...
public class CtcSetUpApi {
    final RemoteSetupManagerPrx remoteSetupManagerPrx;

    public CtcSetUpApi(RemoteSetupManagerPrx remoteSetupManagerPrx) {
    ...
    public class Test {
        public void recoverValue() {
            ...
            stream(getAllSetupNames()).forEach(CtcSetUpApi.this::getSetupAllParams);
        }
    }
}
