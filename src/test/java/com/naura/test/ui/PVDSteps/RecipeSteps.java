...
import com.naura.test.lower.api.RecipeApi;
...
//    @假如("本地存在有效参数的配置文件{string}:")
//    public void 本地存在有效参数的配置文件(String fileName) {
//        createValidFile(fileName);
//    }
//
//    public void createValidFile(String fileName) {
//        FileOption fileOption = new FileOption();
//        String[] fileString = fileOption.createFile(mainPage.editPage().recipePage().getParamInfo().toString());
//        fileOption.changeFileLine(fileString, table.get(0).get("Parameter").toString(), table.get(0).get("1").toString());
...
//    }
    ...
    @并且("{string}配方{string}时")
    public void 配方时(String action, String arg1) {
    }
