...
public class StatusSteps {
    ...
    public void 界面出现报警项目(String alarmName){
        expect(mainPage.alarmPage().statusPage().alarmExist(alarmName)).equals(true);
    }
    ...
    public void 界面上没有报警项目(String alarmName) {
        expect(mainPage.alarmPage().statusPage().alarmUnExist(alarmName)).equals(true);
    }
    ...
    public void 导入alarm文件时(String path) {
        mainPage.alarmPage().queryPage().clickAction("Load");
