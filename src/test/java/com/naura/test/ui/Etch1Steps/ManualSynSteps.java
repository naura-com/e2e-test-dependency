...
public class ManualSynSteps {
    ...
    public void 修改的第个Slot为状态(String LP, int slot, String status) {
        ...
        switch (status) {
            case "WAFER_UNKNOWN":
                mainPage.manualPage().waferSynchPage().setCTCUnknown(String.valueOf(slot - 1));
                break;
            case "WAFER_ABSENT":
                mainPage.manualPage().waferSynchPage().setCTCAbsent(String.valueOf(slot - 1));
                break;
            case "WAFER_PRESENT":
                mainPage.manualPage().waferSynchPage().setCTCPresent(String.valueOf(slot - 1));
                break;
            case "WAFER_XSLOTTED":
                mainPage.manualPage().waferSynchPage().setCTCXslotted(String.valueOf(slot - 1));
                break;
            case "WAFER_DOUBLED":
                mainPage.manualPage().waferSynchPage().setCTCDoubled(String.valueOf(slot - 1));
                break;
        }
    }
    ...
    public void 的第个CTC本来为状态(String LP, int tool, String status) {
        ...
        switch (status) {
            case "WAFER_UNKNOWN":
                mainPage.manualPage().waferSynchPage().setCTCUnknown(String.valueOf(tool - 1));
                mainPage.manualPage().waferSynchPage().synWithCTC();
                break;
            case "WAFER_ABSENT":
                mainPage.manualPage().waferSynchPage().setCTCAbsent(String.valueOf(tool - 1));
                mainPage.manualPage().waferSynchPage().synWithCTC();
                break;
            case "WAFER_PRESENT":
                mainPage.manualPage().waferSynchPage().setCTCPresent(String.valueOf(tool - 1));
                mainPage.manualPage().waferSynchPage().synWithCTC();
                break;
            case "WAFER_XSLOTTED":
                mainPage.manualPage().waferSynchPage().setCTCXslotted(String.valueOf(tool - 1));
                mainPage.manualPage().waferSynchPage().synWithCTC();
                break;
            case "WAFER_DOUBLE":
                mainPage.manualPage().waferSynchPage().setCTCDoubled(String.valueOf(tool - 1));
                mainPage.manualPage().waferSynchPage().synWithCTC();
                break;
        }
    }
