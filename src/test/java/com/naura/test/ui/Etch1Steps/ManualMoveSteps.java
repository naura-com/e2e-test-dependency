...
public class ManualMoveSteps {
    ...
    public void 选择初始模块模块(String module) {
        mainPage.manualPage().manualMovePage().seleteModule(module, "Source");
    }
    ...
    @假如("所有模块已全部装载晶圆")
    public void 所有模块已全部装载晶圆() {
        mainPage.manualPage().waferSynchPage().allModuleSetPresent();
    }
    ...
    public void 选择目的模块模块(String module) {
        mainPage.manualPage().manualMovePage().seleteModule(module, "Destination");
    }
    ...
    public void 选择初始模块模块目的模块模块(String srcModule, String desModule) {
        mainPage.manualPage().manualMovePage().seleteModule(srcModule, "Source");
        mainPage.manualPage().manualMovePage().seleteModule(desModule, "Destination");
    }
