...
public class ChamberSteps {
    ...
    public void 操作成功ModuleStatus状态显示正确(String action, String verification) {
        expect(mainPage.maintainPage().chamberPage().getMouduleStatus(action)).should(verification);
    }
    ...
    public void 处于模式(String arg0, String arg1) {
        ...
        if (!mainPage.maintainPage().chamberPage().getMouduleStatus("Maintain").equals(arg1))
            mainPage.maintainPage().chamberPage().clickAction("Maintain");
    }

    @当("设置chiller温度为{int}度并确认")
    public void 设置chiller温度为度并确认(int arg0) {
        mainPage.maintainPage().chamberPage().clickAction("Chiller");
        mainPage.maintainPage().chamberPage().newDesktopPage("Chamber Chiller", "");
    ...
    public void 设置chiller执行pinup操作() {
        mainPage.maintainPage().chamberPage().clickAction("Pin");
        mainPage.maintainPage().chamberPage().newDesktopPage("Chamber Pin", "");
    ...
    public void 设置的流量值为(String gasName, String value) {
        mainPage.maintainPage().chamberPage().newDesktopPage("table1", "");
    ...
    @并且("在服务窗口执行{string}")
    public void 在服务窗口执行(String operation) {
        mainPage.maintainPage().chamberPage().serviceOperation(operation);
        mainPage.maintainPage().chamberPage().serviceOperation("Close");
    }
    ...
    public void 设置chiller执行rinup操作() {
        mainPage.maintainPage().chamberPage().clickAction("Ring");
        mainPage.maintainPage().chamberPage().newDesktopPage("Chamber Ring", "");
    ...
    public void ring状态变为(String arg0) {
        assertThat(mainPage.maintainPage().chamberPage().ringStatus().equals(arg0)).isTrue();
    }

    @当("设置ESC模块的DC值为{int}")
    public void 设置esc模块的dc值为(int arg0) {
        mainPage.maintainPage().chamberPage().setESCDC(arg0);
        mainPage.maintainPage().chamberPage().ESCRun();
    }
    ...
    public void 设置srfCenter的Forward值为(int arg0) {
        ...
        mainPage.maintainPage().chamberPage().RFRun();
    }
    ...
    public void 日志打印内容(String logStr) {
        ...
        expect(fileOption.checkLog(logStr, appPath + "//logs//log.txt")).equals(true);
    }
    ...
    public void 设置气体流量值如下(DataTable table) {
        mainPage.maintainPage().chamberPage().clickID("btnsetgasflow");
        mainPage.maintainPage().chamberPage().setGasFlows(table);
        mainPage.maintainPage().chamberPage().gasOperation("Run");
    }
    ...
    public void srfEdgeC值变为(int arg0, int arg1) {
        assertThat(mainPage.maintainPage().chamberPage().SRFEdgeCValue(arg0).equals(String.valueOf(arg1))).isTrue();
    }
    ...
    public void srfCerterC值变为(int arg0, int arg1) {
        assertThat(mainPage.maintainPage().chamberPage().SRFCenterCValue(arg0).equals(String.valueOf(arg1))).isTrue();
    }
...
//        assertThat(mainPage.maintainPage().chamberPage().getRunService("Maintain").equals(arg0)).isTrue();
    ...
    public void 设置如下气体流量值执行(String action, DataTable table) {
        mainPage.maintainPage().chamberPage().setMaxMinGasFlows(table, action);
        mainPage.maintainPage().chamberPage().gasOperation("Run");
        mainPage.maintainPage().chamberPage().gasOperation("Close");
    }
    ...
    public void 所有气体流量值执行(String action) {
        mainPage.maintainPage().chamberPage().setAllMaxMinGasFlows(action);
        mainPage.maintainPage().chamberPage().gasOperation("Run");
        mainPage.maintainPage().chamberPage().gasOperation("Close");
    }
    ...
    public void 设置pump为(String pumpName, String pumpState) {
        mainPage.maintainPage().chamberPage().setPump(pumpName, pumpState);
    }
