...
public class ManualProcessSteps {
    ...
    @假如("RecipeList选择{string}")
    public void recipelist选择(String recipe) {
        mainPage.manualPage().manualProcessPage().selectRecipe(recipe);
    }
    ...
    @假如("RecipeList未选择recipe")
    public void recipelist未选择recipe() {
        mainPage.manualPage().manualProcessPage().selectRecipe("");
    }

    @当("选择执行{string}并二次确认时")
    public void 选择执行并二次确认时(String action) {
        mainPage.manualPage().manualProcessPage().clickAction(action);
        mainPage.manualPage().manualProcessPage().clickId("button_Yes");
    }
    ...
    public void 选择执行并二次确认(String action) {
        mainPage.manualPage().manualProcessPage().clickAction(action);
        mainPage.manualPage().manualProcessPage().clickId("btnRun");
    }
