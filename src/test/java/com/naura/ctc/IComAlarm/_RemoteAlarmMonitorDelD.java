...
public final class _RemoteAlarmMonitorDelD extends Ice._ObjectDelD implements _RemoteAlarmMonitorDel
{
    public void
	...
	while(true)
	{
	    ...
	    try
	    {
		RemoteAlarmMonitor __servant = null;
		try
		{
		    __servant = (RemoteAlarmMonitor)__direct.servant();
		}
		...
		try
		{
		    __servant.update(alarmInfo, recoveryRole, timeStamp, __current);
		    return;
		}
