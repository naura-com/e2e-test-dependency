...
public final class _RemoteDataDelM extends Ice._ObjectDelM implements _RemoteDataDel
{
	...
	try
	{
		...
		RemoteDataInfoHolder __ret = new RemoteDataInfoHolder();
	...
	throws IceInternal.LocalExceptionWrapper
    {
	IceInternal.Outgoing __og = __connection.getOutgoing(__reference, "getValue", Ice.OperationMode.Nonmutating, __ctx, __compress);
	try
	{
	    boolean __ok = __og.invoke();
	    try
		...
		RemoteValueInfoHolder __ret = new RemoteValueInfoHolder();
		__is.readObject(__ret.getPatcher());
		__is.readPendingObjects();
		return __ret.value;
	    }
	...
	throws IceInternal.LocalExceptionWrapper
    {
	IceInternal.Outgoing __og = __connection.getOutgoing(__reference, "setValue", Ice.OperationMode.Normal, __ctx, __compress);
	try
	{
	    try
	    {
