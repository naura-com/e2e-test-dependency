...
import com.naura.ctc.IComData.RemoteDataType;
import com.naura.ctc.IComData.RemoteStringTypeInfo;
...
public class RemoteStringParamInfo extends RemoteParamInfo
{
    ...
    public RemoteStringParamInfo(String name, String dataObj, String defaultValue, RemoteDataType type, RemoteStringTypeInfo typeInfo)
    {
