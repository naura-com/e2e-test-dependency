...
public class RemoteIntParamInfo extends RemoteParamInfo
{
    ...
    public RemoteIntParamInfo(String name, String dataObj, String defaultValue, com.naura.pvd.IComData.RemoteDataType type, com.naura.pvd.IComData.RemoteIntTypeInfo typeInfo)
    {
	...
	__is.startReadSlice();
	typeInfo = new com.naura.pvd.IComData.RemoteIntTypeInfo();
    ...
    public com.naura.pvd.IComData.RemoteIntTypeInfo typeInfo;
}
