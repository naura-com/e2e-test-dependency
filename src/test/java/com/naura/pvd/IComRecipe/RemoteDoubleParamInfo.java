...
public class RemoteDoubleParamInfo extends RemoteParamInfo
{
    ...
    public RemoteDoubleParamInfo(String name, String dataObj, String defaultValue, com.naura.pvd.IComData.RemoteDataType type, com.naura.pvd.IComData.RemoteDoubleTypeInfo typeInfo)
    {
	...
	__is.startReadSlice();
	typeInfo = new com.naura.pvd.IComData.RemoteDoubleTypeInfo();
    ...
    public com.naura.pvd.IComData.RemoteDoubleTypeInfo typeInfo;
}
