...
public class RemoteParamInfo extends Ice.ObjectImpl
{
    ...
    public RemoteParamInfo(String name, String dataObj, String defaultValue, com.naura.pvd.IComData.RemoteDataType type)
    {
	this.name = name;
	...
	type = com.naura.pvd.IComData.RemoteDataType.__read(__is);
	__is.endReadSlice();
    ...
    public com.naura.pvd.IComData.RemoteDataType type;
}
