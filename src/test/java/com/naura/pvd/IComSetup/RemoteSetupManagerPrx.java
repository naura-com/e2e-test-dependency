...
public interface RemoteSetupManagerPrx extends Ice.ObjectPrx
{
    ...
    public com.naura.pvd.IComRecipe.RemoteParamInfo[] getSetupAllParams(String name);
    public com.naura.pvd.IComRecipe.RemoteParamInfo[] getSetupAllParams(String name, java.util.Map __ctx);
