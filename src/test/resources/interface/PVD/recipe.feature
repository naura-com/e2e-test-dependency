...
功能: Recipe
  ...
  Rule: storeRcpBody +属性判断，参数冗余
    ...
    场景:存储Rcpbody(覆盖旧版本)
      ...
      """
      那么调用成功
      并且Recipe"/Ch2/sub1/rcp1;1"的Info为:
      """
    ...
    场景:存储Rcpbody(生成新版本)
      ...
      """
      那么调用成功
      并且Recipe"/Ch2/sub1/rcp1;2"的Info为:
      """
      body.steps: | name     | values          |
                  | stepName | [ chuck       ] |
                  | stepName | [ chuck-again ] |
...
#TODO:执行失败:拼写错误 does->dose
  ...
  Rule: registerRcpClass
    ...
    场景: 注册一个新的子Class
      ...
      """
      那么调用成功
      并且RecipeClass"/Ch2/newSubClass"为:
      """
      : {
