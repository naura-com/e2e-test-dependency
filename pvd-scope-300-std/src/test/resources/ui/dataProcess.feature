...
功能:工艺数据界面
  ...
  Rule:基于批次查询
    ...
    场景:基于批次查询时批次号验证
      ...
      那么当前页面显示如下:
      """
      lotList = [test_lot1,test_lot2],
      total = "Total:2",
      lotListInfo = | lotid     | starttime           | endtime             |
                    | test_lot1 | 2022-12-18 00:00:00 | 2022-12-18 01:00:00 |
                    | test_lot2 | 2022-12-18 01:00:00 | 2022-12-18 02:00:00 |
      """
    ...
    场景:基于批次查询时批次信息验证
      ...
      那么当前页面显示如下:
      """
      lotInfo = ["Lot: test_lot   2022-12-18 00:00:00    2022-12-18 01:00:00   (0天1小时0分钟0秒)"]
      """
    ...
    场景:基于批次查询时批次的物料验证
      ...
      那么当前页面显示如下:
      """
      lotWafers["test_lot"] = [LP1.1^01,LP1.2^02]
      """
  ...
  Rule:基于腔室查询
    ...
    场景: 基于腔室查询时物料列表验证
      ...
      假如存在"ChC":
        | triggerTime         | lotId    | mtName | rcpName     | rcpTotalStep | rcpStepCounter | rcpStepName | rcpStepTime | rcpStepElapsedTime |
        | 2022-12-18T08:00:19 | test_lot | LP1.1  | /ChC/test;1 | 2            | 1              | step1       | 10          | 10.01              |
      当查询"2022-12-18-00:00:00"至"2022-12-18-01:00:00"时间段内"基于腔室"的工艺数据时
      那么当前页面显示如下:
      """
      moduleWafers["ChC"] = [LP1.1^01:/ChC/test;1:test_lot]
      """
  ...
  Rule:工艺信息验证
    ...
    场景:基于批次查询时物料工艺信息验证
      ...
      那么当前页面显示如下:
      """
      rcpTitle = "test_lot|LP1.1|/ChC/test;1",
      rcpSteps = |EndTime|StepTime|StartTime|ElapsedTime|StepName|ProcTime|Step|
                 |2022-12-18 00:00:19.456|10|2022-12-18 00:00:05.123|14.333|step1|10.01|1|
                 |2022-12-18 00:00:34.456|10|2022-12-18 00:00:20.123|14.333|step2|10.01|2|,
      rcpStepInfo =  [
          {
              Std: 0,
              Min: 0,
