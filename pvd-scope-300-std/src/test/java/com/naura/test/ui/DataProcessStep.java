...
public class DataProcessStep {
    ...
    public void 批次显示的物料有(String lotId, String verification) {
        expect(mainPage.dataPage().dataProcessPage().lotWafers(lotId)).should(verification);
    }
    ...
    public void 腔室显示的物料有(String module, String verification) {
        expect(mainPage.dataPage().dataProcessPage().moduleWafers(module)).should(verification);
    }
