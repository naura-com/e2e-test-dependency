...
public abstract class Window {
    ...
    protected abstract List<WindowsElement> findElementsById(String id);
    ...
    public List<WindowOperation> elementsById(String id) {
        return findElementsById(id).stream().map(WindowOperation::new).collect(Collectors.toList());
    }
    ...
    public static class WindowOperation extends Window {
        ...
        @Override
        protected List<WindowsElement> findElementsById(String id) {
            return element.findElementsById(id).stream().map(WindowsElement.class::cast).collect(Collectors.toList());
        }
