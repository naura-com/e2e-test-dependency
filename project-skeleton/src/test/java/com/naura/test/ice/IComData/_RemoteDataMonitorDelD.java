...
public final class _RemoteDataMonitorDelD extends Ice._ObjectDelD implements _RemoteDataMonitorDel {
    public void
    update(RemoteValueInfo valueInfo, java.util.Map __ctx)
        ...
        while (true) {
            ...
            try {
                RemoteDataMonitor __servant = null;
                try {
                    __servant = (RemoteDataMonitor) __direct.servant();
                ...
                try {
                    __servant.update(valueInfo, __current);
                    return;
